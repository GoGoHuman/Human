...
if ( ! empty ( $tabs ) ) :
            ...
            <div class="vc_row booking-tabs" style="">
                      ...
                      <div class="wpb_column vc_column_container vc_col-md-4 carousel-singular">
                                <?php echo do_shortcode ( '[rev_slider alias="carouselsingular"]' ); ?>
                      </div>
            </div>
