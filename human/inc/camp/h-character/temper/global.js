...
//alert(offset);
          ...
          $ ( '.main-navigation ul li>a,.mega-menu' ).on ( 'mouseenter', function ( ) {

                    if ( typeof $ ( this ).parent ( 'li' ).attr ( 'class' ) !== 'undefined' && $ ( this ).parent ( 'li' ).attr ( 'class' ).split ( ' ' )[0].indexOf ( 'human-mega' ) > -1 ) {
                              $ ( '.mega-menu' ).fadeOut ( );
                              $ ( '#' + $ ( this ).parent ( 'li' ).attr ( 'class' ).split ( ' ' )[0] ).stop ( ).fadeIn ( );
