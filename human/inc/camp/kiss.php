...
/**
 * Should the developing company wants to white label the product
 * just rename the main theme folder with the name you want
 * - all shortcodes and possible display scenarios will adapt to the theme folder name
 */
...
if ( is_admin () ) {
            require_once HUMAN_BASE_PATH . 'h-heart/admin.class.php';
}
