...
function human_form_elems ( $attr = null ) {
            ...
            $label_after = '';
            if ( $type === 'submit' ) {
                        $elems = '<div class="form-elem-wrapper submit-button-wrapper load-more-wrapper" ><button type="submit" class="button human-form-submit" id="' . $unique_id . '">' . $placeholder . '</button><div class="loading-gif" style="display:none"></div></div>';
                        return $elems;
            }
                                    ...
                                    if ( \is_numeric ( $current_user_id ) ) {
                                                ...
                                                if ( is_wp_error ( $user_dat ) ) {
                                                            wp_send_json_error ( array (
                                                                        'error' => 'Opps Something went wrong, user data or wp_update_user function error, <br> on line ' . __LINE__ . ' in form-builder-beat.php' ) );
                                                }
                                                else {
                                                            // Success!
                                                }
                                                ...
                                                //    wp_send_json_error ( array ( 'error' => 'Opps Something went wrong, form was not submitted, <br>Unknown Ajax Error, User ID is Not Defined on line  ' . __LINE__ . ' in form-builder-beat.php' ) );
                                    }
                        }
