                            ...
                            live('click', function (
                                    e) {
                                        ...
                                        if ($(this).
                                                ...
                                                find('form').
                                                find('.comment_parent_ID').length < 1) {
                                                    $(this).
                                                            closest('.comment-wrapper').
                                                            find('div.human-form-wrapper').
                                                            find('form').
                            ...
                            on('mouseleave', function ( ) {
                                        if ($(this).
                                                ...
                                                val( ).length < 1) {
                                                    ...
                                                    var star = $('.human-comment-form-rating [data-star-number="' + $('#rating').
                                                            val( ) + '"]');
                                                    over_stars($(this).
                                                            val( ), star);
                                        }
                                            ...
                                            $.post(humanAjax.ajaxurl, data, function (
                                                    response) {
                                                        ...
                                                        if (response.success) {
                                                                    ...
                                                                    if (data['data_insert'] > '' && data['data_insert'] != '0') {

                                                                                //console.log(response.data.content.trim().length);
                                                                                if (response.data.content.trim( ).length > 0) {
                                    ...
                                    e) {
                                                                    ...
                                                                    val( ).length < 2) {
                                                                        ...
                                                                        if ($(this).
                                                                                attr("aria-required") == "required") {
                                                                                    if ($(this).
                                                                                            hasClass('human-rating-field')) {
                                                                                                if ($(this).
                                                                                                        val( ).length != 1) {
                                                                                                            $(this).
                                                                                                                    addClass("human-alert");
                                                                                                            alert($(this).
                                                                                                                    next('div.form_field_error').
                                                                                                                    html('data-error'));
                                                                                                }
                                                                                    } else {
                                                                                                //  alert('done');
                                        ...
                                        if (form_id.find(".human-alert").length == 0) {
                                                    ...
                                                    if (form_id.find(".comment_post_ID").length > 0) {
                                                                var comment_post_id = form_id.find(".comment_post_ID").
                                                                        val( );
                                                    }

                                                    var post_id = '';
                                                    if (form_id.find(".post_ID").length > 0) {
                                                                var post_id = form_id.find(".post_ID").
                                                                        val( );
                                                    }
                                                    var current_user = '';
                                                    ...
                                                    if (form_id.find(".comment_parent_ID").length > 0) {
                                                                var comment_parent_id = form_id.find(".comment_parent_ID").
                                                                        val( );
                                                    }
                                                    var comment_metas = [];
                                                    var post_metas = [];
                                                    ...
                                                    if (form_id.find('.subscribe_mailchimp').length > 0) {
                                                                if (form_id.find('.subscribe_mailchimp').
                                                                        val( )) {
                                                                            mailchimp_subscribe = form_id.find('.subscribe_mailchimp').
                                                                                    val( );
                                                                } else {
                                                    ...
                                                    if (form_id.find('.human_mailchimp').length > 0) {
                                                                if (form_id.find('.human_mailchimp').
                                                                        val( )) {
                                                    ...
                                                    $.post(humanAjax.ajaxurl, data, function (
                                                            response) {
                                                                ...
                                                                if (response.success) {
                                                                            ...
                                                                            //      console.log(response['data']['new_comment_id']);
                                                                            if (response['data']['new_comment_id']) {
                                                                                        ...
                                                                                        } else if ($('.human-comments a.load-more').
                                                                                                attr('data-new')) {
