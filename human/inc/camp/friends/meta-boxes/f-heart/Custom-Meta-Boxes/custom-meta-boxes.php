...
if ( ! defined ( 'CMB_PATH' ) )
            define ( 'CMB_PATH', HUMAN_BASE_PATH . '/friends/meta-boxes/f-heart/Custom-Meta-Boxes/' );

if ( ! defined ( 'CMB_URL' ) )
            define ( 'CMB_URL', HUMAN_BASE_URL . '/friends/meta-boxes/f-heart/Custom-Meta-Boxes/' );
