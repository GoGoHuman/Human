...
class ThemeUpdateChecker {
	public $theme = 'human';              //The theme associated with this update checker instance.
	public $metadataUrl = '//human.camp/server/update/latest.json';        //The URL of the theme's metadata file.
	public $enableAutomaticChecking = true; //Enable/disable automatic update checks.
	
	protected $optionName = 'HUMAN_VERSION_INFO';      //Where to store update info.
...
class ThemeUpdate {
 ...
 $human_update_checker = new ThemeUpdateChecker(
    'human',
    'http://human.camp/server/update/latest.json'
);