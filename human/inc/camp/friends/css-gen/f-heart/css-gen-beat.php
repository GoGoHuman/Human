...
class HumanCssGen {
            ...
            public function scripts () {
                        ...
                        wp_enqueue_style ( 'human-fonts-css', explode ( '/wp-content', HUMAN_BASE_URL )[ 0 ] . '/wp-content/human-fonts.css', array (), '123' );
                        wp_dequeue_style ( 'human-parent-css' );
                        wp_enqueue_style ( 'human-parent-css' );

                        wp_enqueue_style ( 'human-dynamic-css', explode ( '/wp-content', HUMAN_BASE_URL )[ 0 ] . '/wp-content/human.css', array (
...
function cssGenAjax () {
            ...
            if ( true ) {
                        ...
                        elseif ( isset ( $_POST[ 'style_gens_minified' ] ) ) {
                                    ...
                                    $style_custom = fopen ( explode ( '/wp-content', HUMAN_BASE_PATH )[ 0 ] . "wp-content/custom-human-css", "w" );
                                    fwrite ( $style_custom, trim ( html_entity_decode ( stripslashes ( $_POST[ 'custom_css' ] ) ) ) );
                                    fclose ( $style_custom );
                                    ...
                                    $response = array (
                                                'saved' => 'saving',
                                                'style_html' => base64_decode ( $_POST[ 'style_gens' ] )
                                    );
                        }
