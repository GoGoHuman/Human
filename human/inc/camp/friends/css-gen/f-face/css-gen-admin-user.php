...
function css_builder ( $css_font_list ) {
            ...
            $global = [ ];
            $global_tags = [ ];
            if ( get_option ( 'human_css_sections' ) ) {
                                                              ...
                                                              <td>
                                                                        <div class="custom-select vc-100" >
                                                                                  <select id="template_wraps"  class="human_top_section_selects" style="">
                                                                                            <option value=""  class="default_sections" <?php if ( isset ( $global[ 0 ] ) ) {
                                                                                                    echo $global[ 0 ];
                                                                                        } ?>>CSS Folders</option>
            ...
            <div id="custom-css-div-holder" class='toggles' style="display:none">
                    <?php
                    if ( is_file ( HUMAN_BASE_PATH . 'friends/css-gen/f-face/templates/custom-css.html' ) ) {


                                $human_custom_css = file_get_contents ( HUMAN_BASE_PATH . 'friends/css-gen/f-face/templates/custom-css.html' );
                    }
                    else {
                                $human_custom_css = '';
                    }
