...
// the query
            ...
            if ( isset ( $_GET[ 'results' ] ) && isset ( $attr[ 'human_search' ] ) ) {
                        $post_type = '';
                        $tagname = urldecode ( esc_html ( $_GET[ 'results' ] ) );

                        $post_id = ''; //tag_' . $tagname;
                        //       $search_title = '<div class="human-search-title">' . urldecode ( $tagname ) . '</div>';
...
//echo '<hr>';
            ...
            if ( $the_query->have_posts () ) {
                        ...
                        echo "<div class='wpb_column'><h3>Sorry we couldn't find anything matching your search term, please try something else</h3></div>";
            }
            $load_more = ' load more ';
...
//$human_looped_template_id=0;
            ...
            if ( isset ( $attr[ 'data_extra' ] ) ) {
                        ...
                        if ( $count_comments > 0 ) {
                                    $load_more_btn = ' <hr><div class="load-more-wrapper"><a href=\'#\' class=\'button-link load-more ' . $load_more_button_hide . '\' data-type=\'comments\' data-extra=\'' . $shortcode . '\' data-reply=\'' . $reply_shortcode . '\' data-new=\'' . $new_shortcode . '\'>' . $load_more . '</a>
                                    ...
                                    $load_more_btn = ' <hr><div class="load-more-wrapper"><a href=\'#\' class=\'button-link load-more ' . $load_more_button_hide . '\' data-type=\'comments\' data-extra=\'' . $shortcode . '\' data-reply=\'' . $reply_shortcode . '\' data-new=\'' . $new_shortcode . '\' style="display:none">' . $load_more . '</a>
                                                                       <div class="loading-gif comments-loading-gif" style="display:none"></div></div>';
